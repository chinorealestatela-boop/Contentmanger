...
import {
  Phone, StickyNote, Workflow, CalendarClock, CheckSquare,
  Trophy, XCircle, RefreshCcw, Zap, UserPlus, Repeat, PhoneCall, CalendarX, CalendarCheck2,
  Star, Sparkles, DollarSign, FileText, IdCard, Plane,
  type LucideIcon,
} from "lucide-react";
