...
import { updateAppointment, rescheduleAppointment, updateAppointmentStatus, type AppointmentActionState } from "@/lib/actions/appointments";
 ...
 * calendar, customer profile, and (for appointments booked online) the
 * customer's SMS/email reminders in sync automatically. */
  ...
  return (
    <Modal title="Reschedule Appointment" onClose={onClose}>
      <form ref={formRef} action={formAction} className="space-y-4">
        ...
        <p className="text-xs text-[var(--text-muted)]">If this appointment was booked online, the customer gets an automatic text/email about the new time.</p>
