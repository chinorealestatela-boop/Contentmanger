...
export default async function LeadSourcesSettingsPage() {
  ...
  return (
    <SettingsShell isAdmin={["OWNER", "ADMIN"].includes(scope.role)} title="Lead Sources" subtitle="Where your leads come from. Inactive sources are hidden from new-lead forms but stay on historical records.">
